{
  ...
  if (typeof $orders == 'undefined' || $orders.length <= 0) {
    const $orderList = document.querySelector('.orders');
      ...
      $div.innerHTML =`
      <img srcset="./src/assets/img/coffee-maker.png 67w, ./src/assets/img/coffee-maker@2x.png" 134w" sizes="67px, 134px" src="./src/assets/img/coffee-maker.png" alt="A coffee maker"/>
